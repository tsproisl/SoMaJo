...
class TestSplitOnBoundaries(unittest.TestCase):
    ...
    def test_split_on_boundaries_01(self):
        ...
        self.tokenizer._split_on_boundaries(token_dll.first, [(1, 3, None), (5, 8, None)], "foo")
        self.assertEqual([t.text for t in token_dll.to_list()], "1 23 45 678 9".split())
        tokens = token_dll.to_list()
        self.assertEqual(tokens[1].token_class, "foo")
        self.assertEqual(tokens[3].token_class, "foo")
    ...
    def test_split_on_boundaries_02(self):
        ...
        tokens = token_dll.to_list()
        self.assertEqual(tokens[0].token_class, "foo")
        self.assertEqual(tokens[2].token_class, "foo")
    ...
    def test_split_on_boundaries_05(self):
        token_dll = DLL([Token("12 456 89")])
        self.tokenizer._split_on_boundaries(token_dll.first, [(1, 3, None), (5, 8, None)], "foo", delete_whitespace=True)
    ...
    def test_split_on_boundaries_06(self):
        ...
        self.tokenizer._split_on_boundaries(token_dll.first, [(0, 2, None), (6, 9, None)], "foo")
    ...
    def test_split_on_boundaries_07(self):
        token_dll = DLL([Token("123456789")])
        self.tokenizer._split_on_boundaries(token_dll.first, [(1, 3, "repl1"), (5, 8, "repl2")], "foo")
